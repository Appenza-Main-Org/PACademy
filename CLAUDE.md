...
- **Status:** Frontend feature-complete; design polish complete (`polish-complete` tag, 2026-05-03); **backend spec 005 (modular monolith) complete** (2026-05-10); major scope-alignment + admission-setup-wizard + lookups + admin-users-NID + applicant-grades work landed through 2026-05-16.
