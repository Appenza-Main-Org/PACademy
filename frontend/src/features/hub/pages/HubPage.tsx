...
const APPS: readonly AppDef[] = [
  ...
  { key: 'committee',      Icon: ClipboardList,  num: '2.1', title: 'لجان القبول',                   desc: 'تنظيم لجان قبول المتقدمين وإدارة بياناتهم وربط مراحل التقدم',          path: '/admin/committee', platform: 'شبكة داخلية', stat: '5 لجان نشطة' },
