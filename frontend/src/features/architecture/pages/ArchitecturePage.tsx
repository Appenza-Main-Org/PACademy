...
const ROLE_LABELS_EN: Record<Role, string> = {
  ...
  applicant:           'Applicant',
  student_committee_head: 'Student Committee Head',
  exam_committee_head: 'Exam Committee Head',
  security_gate_user:  'Security Gate User',
  admissions_system_admin: 'Admissions System Admin',
  medical_committee_head: 'Medical Committee Head',
  medical_clinic_manager: 'Medical Clinic Manager',
