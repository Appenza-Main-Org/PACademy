...
/* ─── 11. governorates — official Egyptian NID codes ──────────────── */

const governorates: GovernorateRow[] = [
  // Greater Cairo
  { code: '01', name: 'محافظة القاهرة',        isActive: true, region: 'القاهرة الكبرى', nationalIdCode: '01' },
  { code: '21', name: 'محافظة الجيزة',         isActive: true, region: 'القاهرة الكبرى', nationalIdCode: '21' },
  { code: '14', name: 'محافظة القليوبية',      isActive: true, region: 'القاهرة الكبرى', nationalIdCode: '14' },
  // Lower Egypt (Delta)
  { code: '02', name: 'محافظة الإسكندرية',     isActive: true, region: 'الوجه البحري', nationalIdCode: '02' },
  { code: '12', name: 'محافظة الدقهلية',       isActive: true, region: 'الوجه البحري', nationalIdCode: '12' },
  { code: '13', name: 'محافظة الشرقية',        isActive: true, region: 'الوجه البحري', nationalIdCode: '13' },
  { code: '17', name: 'محافظة المنوفية',       isActive: true, region: 'الوجه البحري', nationalIdCode: '17' },
  { code: '18', name: 'محافظة البحيرة',        isActive: true, region: 'الوجه البحري', nationalIdCode: '18' },
  { code: '16', name: 'محافظة الغربية',        isActive: true, region: 'الوجه البحري', nationalIdCode: '16' },
  { code: '15', name: 'محافظة كفر الشيخ',      isActive: true, region: 'الوجه البحري', nationalIdCode: '15' },
  { code: '11', name: 'محافظة دمياط',          isActive: true, region: 'الوجه البحري', nationalIdCode: '11' },
  // Upper Egypt
  { code: '22', name: 'محافظة بني سويف',       isActive: true, region: 'الوجه القبلي', nationalIdCode: '22' },
  { code: '23', name: 'محافظة الفيوم',         isActive: true, region: 'الوجه القبلي', nationalIdCode: '23' },
  { code: '24', name: 'محافظة المنيا',         isActive: true, region: 'الوجه القبلي', nationalIdCode: '24' },
  { code: '25', name: 'محافظة أسيوط',          isActive: true, region: 'الوجه القبلي', nationalIdCode: '25' },
  { code: '26', name: 'محافظة سوهاج',          isActive: true, region: 'الوجه القبلي', nationalIdCode: '26' },
  { code: '27', name: 'محافظة قنا',             isActive: true, region: 'الوجه القبلي', nationalIdCode: '27' },
  { code: '29', name: 'محافظة الأقصر',          isActive: true, region: 'الوجه القبلي', nationalIdCode: '29' },
  { code: '28', name: 'محافظة أسوان',           isActive: true, region: 'الوجه القبلي', nationalIdCode: '28' },
  // Canal
  { code: '03', name: 'محافظة بورسعيد',         isActive: true, region: 'القناة', nationalIdCode: '03' },
  { code: '19', name: 'محافظة الإسماعيلية',     isActive: true, region: 'القناة', nationalIdCode: '19' },
  { code: '04', name: 'محافظة السويس',          isActive: true, region: 'القناة', nationalIdCode: '04' },
  // Frontier
  { code: '31', name: 'محافظة البحر الأحمر',    isActive: true, region: 'الحدود', nationalIdCode: '31' },
  { code: '32', name: 'محافظة الوادي الجديد',   isActive: true, region: 'الحدود', nationalIdCode: '32' },
  { code: '33', name: 'محافظة مطروح',           isActive: true, region: 'الحدود', nationalIdCode: '33' },
  { code: '34', name: 'محافظة شمال سيناء',      isActive: true, region: 'الحدود', nationalIdCode: '34' },
  { code: '35', name: 'محافظة جنوب سيناء',      isActive: true, region: 'الحدود', nationalIdCode: '35' },
  { code: '88', name: 'خارج الجمهورية',         isActive: true, region: 'الحدود', nationalIdCode: '88' },
];
...
const policeStations: PoliceStationRow[] = [
  ...
  { code: 'PST-0004', name: 'قسم النزهة',          isActive: true, governorateCode: '01', kind: 'قسم' },
  { code: 'PST-0005', name: 'قسم مدينة نصر أول',   isActive: true, governorateCode: '01', kind: 'قسم' },
  { code: 'PST-0006', name: 'قسم مصر الجديدة',     isActive: true, governorateCode: '01', kind: 'قسم' },
  { code: 'PST-0007', name: 'قسم المعادي',         isActive: true, governorateCode: '01', kind: 'قسم' },
  ...
  { code: 'PST-0014', name: 'قسم بولاق الدكرور',   isActive: true, governorateCode: '21', kind: 'قسم' },
  { code: 'PST-0015', name: 'قسم الهرم',           isActive: true, governorateCode: '21', kind: 'قسم' },
...
/* Certificate-source axis only — where the applicant's secondary
 * grades come from. `externalGradesImport: true` flags the sources
 * the `/admin/applicant-grades` importer hands files in for. */
