...
export function Sidebar({ sections }: SidebarProps): JSX.Element {
  ...
  return (
    <aside
      ...
      className="sticky top-16 hidden h-[calc(100dvh_-_64px)] w-64 flex-shrink-0 overflow-y-auto border-s border-border-subtle bg-surface-card px-3 py-4 md:block"
    >
