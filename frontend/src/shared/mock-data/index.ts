...
const committees: Committee[] = [
  {
    ...
    specializationIds: ['SPC-01', 'SPC-02'], officerIds: ['U-002', 'U-005'],
    rules: { gradeFrom: 75, gradeTo: 100, alphabetFrom: 'أ', alphabetTo: 'د', gender: 'male', applicantType: 'officers_general' },
  },
  {
    ...
    specializationIds: ['SPC-03', 'SPC-05'], officerIds: ['U-002', 'U-005'],
    rules: { gradeFrom: 70, gradeTo: 100, alphabetFrom: 'ذ', alphabetTo: 'س', gender: 'male', applicantType: 'officers_general' },
  },
  {
    ...
    specializationIds: ['SPC-04', 'SPC-12'], officerIds: ['U-005'],
    rules: { gradeFrom: 80, gradeTo: 100, alphabetFrom: 'ش', alphabetTo: 'ع', gender: 'male', applicantType: 'officers_specialized' },
  },
  {
    ...
    specializationIds: ['SPC-06', 'SPC-07'], officerIds: ['U-002', 'U-005'],
    rules: { gradeFrom: 70, gradeTo: 100, alphabetFrom: 'غ', alphabetTo: 'م', gender: 'male', applicantType: 'officers_general' },
  },
  {
    ...
    specializationIds: ['SPC-08', 'SPC-09', 'SPC-10'], officerIds: ['U-005'],
    rules: { gradeFrom: 65, gradeTo: 100, alphabetFrom: 'ن', alphabetTo: 'ي', gender: 'female', applicantType: 'institute_traffic' },
  },
];
