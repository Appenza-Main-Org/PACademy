...
namespace PACademy.Admin.Api.Persistence.Migrations
{
    ...
    [Migration("20260614205346_AddBarcodeSequences")]
    partial class AddBarcodeSequences
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PACademy.Admin.Api.Modules.Admissions.CategoryEducationFieldEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(96)
                        .HasColumnType("nvarchar(96)")
                    ...
                    b.HasIndex("CategoryKey", "FieldKey")
                        .IsUnique()
                        .HasDatabaseName("ux_category_education_fields_category_field");

                    b.HasIndex("CategoryKey", "SortOrder")
                        .HasDatabaseName("ix_category_education_fields_category_sort");

                    b.ToTable("category_education_fields", "dbo");
                });
            ...
            modelBuilder.Entity("PACademy.Admin.Api.Persistence.BarcodeSequenceEntity", b =>
                {
                    b.Property<string>("CycleId")
                        .HasMaxLength(96)
                        .HasColumnType("nvarchar(96)")
                    ...
                    b.HasKey("CycleId", "CommitteeCode");

                    b.ToTable("barcode_sequences", "dbo");
                });
