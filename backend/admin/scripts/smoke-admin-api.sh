...
expect_node "committee instances seed is empty without mock seed" "/api/committee-instances" "Array.isArray(data) && data.length === 0"
expect_node "committees seed is empty without mock seed" "/api/committees" "Array.isArray(data) && data.length === 0"
